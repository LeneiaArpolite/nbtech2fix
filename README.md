...
这是从 1.21.1 NeoForge 原工程独立移植的 Minecraft 1.20.1 版本。原工程未被覆盖。
...
未移植的旧功能：MMSM 免死耗电整数除法、MMSM 空中游泳、相位第三人称镜头、DE 模型懒加载。原因分别是 1.20.1 最新目标版本中 bug 或目标模块不存在，或已经由上游处理；强行注入会改变既有逻辑。Iris/Oculus、Sodium/Embeddium 与 DE 的渲染兼容修复已明确移除，不再包含在本版本中。
